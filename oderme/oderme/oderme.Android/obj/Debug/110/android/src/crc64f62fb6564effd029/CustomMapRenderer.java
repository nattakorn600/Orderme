...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("oderme.Droid.Renderers.CustomMapRenderer, oderme.Android", CustomMapRenderer.class, __md_methods);
	}
	...
	public CustomMapRenderer (android.content.Context p0)
	{
		...
		if (getClass () == CustomMapRenderer.class)
			mono.android.TypeManager.Activate ("oderme.Droid.Renderers.CustomMapRenderer, oderme.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
	...
	public CustomMapRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == CustomMapRenderer.class)
			mono.android.TypeManager.Activate ("oderme.Droid.Renderers.CustomMapRenderer, oderme.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
	...
	public CustomMapRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == CustomMapRenderer.class)
			mono.android.TypeManager.Activate ("oderme.Droid.Renderers.CustomMapRenderer, oderme.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
